...
opencr_port.write("position," + "0.2," + "0.2," + "0.1," + '\n');
...
void getData()
{
  ...
  open_manipulator.makeJointTrajectory("gripper", goal_position, 0.5, open_manipulator.getManipulator()->getAllActiveJointValue());
